...
public interface HasJavaAnnotationObservers<T, A> {

	void addJavaAnnotationObserver(JavaAnnotationObserver<T,A> observer);
	void removeJavaAnnotationObserver(JavaAnnotationObserver<T,A> observer);
