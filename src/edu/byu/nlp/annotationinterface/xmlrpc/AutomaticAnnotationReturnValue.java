...
/**
 * The Return value for AutomaticAnnotationProvider
 * 
 * @author plf1
 *
 */
@Deprecated
public interface AutomaticAnnotationReturnValue extends Serializable {
	
	/**
	 * @return the pre-annotation the client should use for the instance.
	 */
	String getAutomaticAnnotationValue();
	
	long getAutomaticAnnotatorId();
