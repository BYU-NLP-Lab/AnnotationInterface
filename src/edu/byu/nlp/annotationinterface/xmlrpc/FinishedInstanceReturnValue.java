...
/**
 * This class is a marker that an instance provider is finished providing
 * instances for a particular user. If InstanceProvider.nextInstance(userId)
 * returns a FinishedReturnValue, then the user is finished annotating.
 * @author plf1
 *
 */
@Deprecated
public class FinishedInstanceReturnValue implements InstanceReturnValue {
