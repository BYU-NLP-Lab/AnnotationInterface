...
public interface AnnotationManagerSerializer<T, A> {

	String serializeInstance(T instance);

	String serializeAnnotation(A annotation);
	
	A deserializeAnnotation(String serializedAnnotation);
